# Proxy-Wasm ABI v0.1.0 specification
...
Retrieves WasmVM or Plugin configuration (depending on the callback it was
called from).
...
Paused HTTP requests can be resumed using [`proxy_continue_request`].
...
Paused HTTP requests can be resumed using [`proxy_continue_response`].
...
Paused HTTP responses can be resumed using [`proxy_continue_response`].
...
[`proxy_abi_version_0_1_0`]: #proxy_abi_version_0_1_0
